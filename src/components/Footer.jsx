    ...
    <footer className="grid grid-cols-1 lg:grid-cols-2 items-center gap-10 lg:gap-20 justify-center text-primary relative py-14 lg:py-20 px-10 lg:px-[190px] z-50">
      ...
      <div className="flex flex-col items-center lg:items-start gap-3">
        ...
        <div className="relative">
          <p className="text-center lg:text-left text-[14px] lg:text-[24px] font-bold mx-5 lg:mx-0">
            The Future of Investing in the Mining Industry with Blockchain
          </p>
        </div>
        <div className="relative">
          <p className="text-center lg:text-left text-[12px] lg:text-[18px]">
            The first digital token backed by real, mined assets. A bridge
      ...
      <div className="flex flex-col items-center lg:items-start justify-center relative gap-2">
        ...
        <input
          ...
          className="placeholder:text-left bg-white text-[14px] lg:text-[18px] font-bold pr-[80px] pl-[20px] py-[14.5px] rounded-xl lg:w-full"
        />
