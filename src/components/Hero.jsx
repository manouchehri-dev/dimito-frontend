  ...
  return (
    <section className="grid grid-cols-1 lg:grid-cols-2 pt-[100px] lg:pt-[140px]">
      ...
      <div className="flex flex-col items-center lg:items-start lg:px-20 lg:py-10 gap-4 lg:gap-8 font-poppins">
        ...
        <h1 className="text-[24px] lg:text-[50px] font-bold text-center lg:text-start px-10 lg:px-0">
          {t("title")}
        </h1>
        <span className="text-center lg:text-start px-6 lg:px-0 lg:text-[30px]">
          {t("description")}
        </span>
