        ...
        <div className={`absolute ${isRTL ? "left-0" : "right-0"} mt-2 w-80 sm:w-96 bg-white border border-gray-200 rounded-xl shadow-xl z-[70] overflow-hidden backdrop-blur-sm`}>
          ...
          <div className="p-2 border-b border-gray-100">
            <button
              ...
              className="w-full flex items-center gap-2 px-3 py-2 text-sm font-medium text-gray-700 hover:bg-blue-50 hover:text-blue-700 rounded-md transition-colors duration-150"
            >
              <LayoutDashboard className="w-4 h-4" />
              <span className="flex-1 text-end">{t('dashboard')}</span>
            </button>
          </div>
          ...
          <div className="p-3 space-y-2 border-t border-gray-100">
            ...
            >
              <LogOut className="w-5 h-5 group-hover:text-red-700" />
              <span className="flex-1 text-end">{authMethod === 'sso' ? t('logout') : 'SSO Logout'}</span>
            </button>
            ...
            {isConnected ? (
              <button
                onClick={handleWalletLogout}
                className="w-full flex items-center gap-3 px-4 py-3 text-sm font-medium text-orange-600 hover:bg-gradient-to-r hover:from-orange-50 hover:to-yellow-50 hover:text-orange-700 rounded-lg transition-all duration-200 group border border-transparent hover:border-orange-200"
              >
              ...
              <button
                ...
                className="w-full flex items-center gap-3 px-4 py-3 text-sm font-medium text-green-600 hover:bg-gradient-to-r hover:from-green-50 hover:to-emerald-50 hover:text-green-700 rounded-lg transition-all duration-200 group border border-transparent hover:border-green-200"
              >
                <Wallet className="w-5 h-5 group-hover:text-green-700" />
                <span className="flex-1 text-left">{isRTL ? 'اتصال کیف پول' : t('connectWallet')}</span>
              </button>
            )}
          </div>
        </div>
