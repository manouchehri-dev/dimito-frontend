...
const Header = () => {
  return (
    <header className="grid grid-cols-3 fixed top-0 left-0 right-0 z-50 justify-between items-center p-4 lg:p-6 bg-white text-primary rounded-[8px] lg:rounded-[24px] mt-[13px] mx-[14px] lg:mx-[71px] ">
