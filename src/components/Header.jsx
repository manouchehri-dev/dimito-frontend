              ...
              {navItems.map((item) => (
                <li key={item.href}>
                  <NavLink
                    href={item.href}
                    active={item.active}
                    className={`px-4 xl:px-6 py-2.5 xl:py-3 rounded-full text-[14px] xl:text-[16px] font-medium transition-all duration-200 whitespace-nowrap ${
                      item.active
              ...
              {navItems.map((item, index) => (
                <li key={item.href}>
                  <NavLink
                    href={item.href}
                    active={item.active}
                    className={`block px-6 py-4 text-[16px] font-medium transition-all duration-200 rounded-xl ${
                      item.active
